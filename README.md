...
After discovery each device will be added to a new hostgroup in the format of "Meraki Organization Name/Meraki Network Name".  Each host is also added to a new hostgroup "Meraki Disovered Devices"
